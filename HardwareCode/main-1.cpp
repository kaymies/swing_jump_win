...
//                }
                ...
                //if (t.read() >= tih) {
//                    
//                    current_des2 = -1*(-K_yy*(th2 - th2_limu) - D_yy*(dth2))/k_t; // negative sign so goes clockwise
//                    
//                }else {
//                    current_des2 = 0.0;
//                }   
                ...
                if (t.read() >= tipre && t.read() <= tih) {
                    ...
                    current_des2 = (-K_yy*(th2 - thpre) - D_yy*(dth2))/k_t; // negative sign so goes clockwise
                    
                } else if (t.read() >= tih && th2 < th2_limu) {
                    current_des2 = -max_torque/k_t;
                } else {
                    current_des2 = 0.0;
                }              
